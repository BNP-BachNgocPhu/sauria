...
VL_ATTR_COLD void Vsauria_tester_feed_xy_lane__F5_W3___ctor_var_reset(Vsauria_tester_feed_xy_lane__F5_W3* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsauria_tester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vsauria_tester_feed_xy_lane__F5_W3___ctor_var_reset\n"); );
    // Body
    vlSelf->i_clk = VL_RAND_RESET_I(1);
    vlSelf->i_rstn = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(128, vlSelf->i_sram_data);
    ...
    vlSelf->i_glob_woffs = VL_RAND_RESET_I(3);
    vlSelf->i_loc_woffs = VL_RAND_RESET_I(8);
    vlSelf->i_Dil_pat = VL_RAND_RESET_Q(64);
    ...
    VL_RAND_RESET_W(128, vlSelf->__PVT__feed_data_manager_i__DOT__sram_elements);
    ...
    vlSelf->__PVT__feed_data_manager_i__DOT__lshifted_dil_pat = VL_RAND_RESET_I(8);
    vlSelf->__PVT__feed_data_manager_i__DOT__rshifted_dil_pat = VL_RAND_RESET_I(8);
    vlSelf->__PVT__feed_data_manager_i__DOT__shifted_dil_pat_d = VL_RAND_RESET_I(8);
    vlSelf->__PVT__feed_data_manager_i__DOT__shifted_dil_pat_q = VL_RAND_RESET_I(8);
    vlSelf->__PVT__feed_data_manager_i__DOT__final_dil_pat = VL_RAND_RESET_I(8);
    ...
    vlSelf->__PVT__feed_data_manager_i__DOT__elm_number = VL_RAND_RESET_I(4);
    vlSelf->__PVT__feed_data_manager_i__DOT__elm_number_sat = VL_RAND_RESET_I(2);
    vlSelf->__PVT__feed_data_manager_i__DOT__par_sums = VL_RAND_RESET_I(32);
    vlSelf->__PVT__feed_data_manager_i__DOT__elm_idx_array = VL_RAND_RESET_I(32);
    vlSelf->__PVT__feed_data_manager_i__DOT__regs_used_idx = VL_RAND_RESET_I(4);
    vlSelf->__PVT__feed_data_manager_i__DOT__new_active_idx = VL_RAND_RESET_I(5);
    vlSelf->__PVT__feed_data_manager_i__DOT__regs_active_new = VL_RAND_RESET_I(3);
    vlSelf->__PVT__feed_data_manager_i__DOT__regs_active_d = VL_RAND_RESET_I(3);
    vlSelf->__PVT__feed_data_manager_i__DOT__regs_active_q = VL_RAND_RESET_I(3);
    vlSelf->__PVT__feed_data_manager_i__DOT__regs_en_d = VL_RAND_RESET_I(3);
    vlSelf->__PVT__feed_data_manager_i__DOT__regs_d = VL_RAND_RESET_Q(48);
    vlSelf->__PVT__feed_data_manager_i__DOT__regs_q = VL_RAND_RESET_Q(48);
    vlSelf->__PVT__feed_data_manager_i__DOT__n_free_regs = VL_RAND_RESET_I(2);
    vlSelf->__PVT__feed_data_manager_i__DOT__target_array = VL_RAND_RESET_I(32);
    vlSelf->__PVT__feed_data_manager_i__DOT__mux_control_array = VL_RAND_RESET_I(12);
    ...
    VL_RAND_RESET_W(240, vlSelf->__PVT__fifo_i__DOT__data_q);
    VL_RAND_RESET_W(240, vlSelf->__PVT__fifo_i__DOT__data_mux);
    vlSelf->__PVT__fifo_i__DOT__reg_en = VL_RAND_RESET_I(5);
    vlSelf->__PVT__fifo_i__DOT__mux_sel = VL_RAND_RESET_I(5);
    vlSelf->__PVT__fifo_i__DOT__data_pop_q = VL_RAND_RESET_Q(48);
    ...
    vlSelf->fifo_i__DOT____Vlvbound_h6ac077c1__0 = VL_RAND_RESET_Q(48);
    vlSelf->fifo_i__DOT____Vlvbound_h6ac077c1__2 = VL_RAND_RESET_Q(48);
    vlSelf->fifo_i__DOT____Vlvbound_h6ac077c1__3 = VL_RAND_RESET_Q(48);
}
