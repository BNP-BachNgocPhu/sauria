...
VL_ATTR_COLD void Vsauria_tester_axi_lite_mux__pi15___settle__TOP__sauria_tester__DOT__dut__DOT__core_cfg_mux_i__DOT__i_axi_mux__0(Vsauria_tester_axi_lite_mux__pi15* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsauria_tester_axi_lite_mux__pi15___settle__TOP__sauria_tester__DOT__dut__DOT__core_cfg_mux_i__DOT__i_axi_mux__0\n"); );
    // Body
    vlSelf->__PVT__gen_mux__DOT__i_aw_arbiter__DOT__gen_arbiter__DOT__gen_int_rr__DOT__gen_fair_arb__DOT__upper_mask 
        = (2U & (IData)(vlSelf->__PVT__gen_mux__DOT__i_aw_arbiter__DOT__gen_arbiter__DOT__gen_int_rr__DOT__gen_fair_arb__DOT__upper_mask));
    vlSelf->__PVT__gen_mux__DOT__i_ar_arbiter__DOT__gen_arbiter__DOT__gen_int_rr__DOT__gen_fair_arb__DOT__upper_mask 
        = (2U & (IData)(vlSelf->__PVT__gen_mux__DOT__i_ar_arbiter__DOT__gen_arbiter__DOT__gen_int_rr__DOT__gen_fair_arb__DOT__upper_mask));
...
VL_ATTR_COLD void Vsauria_tester_axi_lite_mux__pi15___settle__TOP__sauria_tester__DOT__dut__DOT__dma_cfg_mux_i__DOT__i_axi_mux__0(Vsauria_tester_axi_lite_mux__pi15* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsauria_tester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsauria_tester_axi_lite_mux__pi15___settle__TOP__sauria_tester__DOT__dut__DOT__dma_cfg_mux_i__DOT__i_axi_mux__0\n"); );
    // Body
    vlSelf->__PVT__gen_mux__DOT__i_aw_arbiter__DOT__gen_arbiter__DOT__gen_int_rr__DOT__gen_fair_arb__DOT__upper_mask 
        = (2U & (IData)(vlSelf->__PVT__gen_mux__DOT__i_aw_arbiter__DOT__gen_arbiter__DOT__gen_int_rr__DOT__gen_fair_arb__DOT__upper_mask));
    vlSelf->__PVT__gen_mux__DOT__i_ar_arbiter__DOT__gen_arbiter__DOT__gen_int_rr__DOT__gen_fair_arb__DOT__upper_mask 
