...
VL_ATTR_COLD void Vsauria_tester_FIFO_WRITE__D80___ctor_var_reset(Vsauria_tester_FIFO_WRITE__D80* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsauria_tester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vsauria_tester_FIFO_WRITE__D80___ctor_var_reset\n"); );
    // Body
